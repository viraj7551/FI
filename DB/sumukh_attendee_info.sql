...
CREATE TABLE `attendee_info` (
  ...
  `attendee_firstname` varchar(20) NOT NULL,
  `attendee_lastname` varchar(20) NOT NULL,
  `attendee_count` mediumtext NOT NULL,
  `userId` int DEFAULT NULL,
  PRIMARY KEY (`attendee_id`),
  KEY `fk_attendee_info` (`userId`),
  CONSTRAINT `fk_attendee_info` FOREIGN KEY (`userId`) REFERENCES `user_info` (`userId`) ON DELETE CASCADE
...
-- Dump completed on 2024-10-16 10:45:22
